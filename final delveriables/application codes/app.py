...
def addItem():
    if request.method == "POST":
        ...
        new_file_path=pics
        image="https://menspants.s3.jp-tok.cloud-object-storage.appdomain.cloud/"+name+".png"
        upload_large_file(new_bucket_name, new_item_name,new_file_path)
        try:
           conn =ibm_db.connect("DATABASE=bludb;HOSTNAME=9938aec0-8105-433e-8bf9-0fbb7e483086.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=32459;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=zlp37297;PWD=so1e9MAlFSDzhxfs",'','')
...
def register():
     ...
     if request.method == 'POST':
         ...
         if account:
           ...
           sg = sendgrid.SendGridAPIClient('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')
           from_email = Email("jayakamalesh.007@gmail.com")
           to_email = To(email)
           subject = "welcome to our smart fashion recommendation"
           content = Content("text/plain", "further updates will sended to your mail")
...
COS_API_KEY_ID = "l3fM5rXs5ycS8W4SAclnSNJPsk6MMEVuExuEoeVJPJFW" # example: xxxd12V2QHXbjaM99G9tWyYDgF_0gYdlQ8aWALIQxXx4
COS_AUTH_ENDPOINT = "https://iam.cloud.ibm.com/identity/token"
COS_SERVICE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/b9916d3d37d24674be1984ac2159a53c:da69c0d9-9adb-46b9-b72c-582469fca7ab::" # example: crn:v1:bluemix:public:cloud-object-storage:global:a/xx999cd94a0dda86fd8eff3191349999:9999b05b-x999-4917-xxxx-9d5b326a1111::
